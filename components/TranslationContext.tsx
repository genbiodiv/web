...
const translations = {
  es: {
    ...
    'nav.brand': 'Laboratorio de Genómica y Biodiversidad del Caribe',
    'hero.title': 'Laboratorio de Genómica y',
    ...
    'team.btn': 'Ver Directorio del Equipo (27 Colaboradores)',
  ...
  en: {
    ...
    'nav.team': 'Team',
    'nav.contact': 'Contact',
    'nav.brand': 'Laboratory of Genomics & Biodiversity of the Caribbean',
    'hero.title': 'Laboratory of Genomics &',
    ...
    'team.btn': 'View Team Directory (27 Contributors)',
